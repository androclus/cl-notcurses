...
// Sample program originally by Wyatt Sheffield at
//    https://wyatts.xyz/blog/writingasimpleno_2020-02-09
// adapted/updated by Jeff Stern Dec 2025
//
// Draw 25 rows of 25 asterisks
...
int main(){
  ...
  for (int i = 0; i < 25; i++){
    for (int j = 0; j < 25; j++){
      ...
      // (I don't know why Wyatt wanted to do this. It is not
      // necessary I think.)
      sleep (0.05);
    }
  }

  // hold the picture on the screen for 2 seconds
  sleep(2);
